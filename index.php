<?php
// Esta página muestra el inicio de la tienda.
$page = 'index';
...
<input id="home-search" class="form-control" type="search" name="q" maxlength="200" placeholder="¿Qué juguete buscas?">
<button class="btn action" type="submit">Buscar</button></div>
                    </form>
                    <div class="actions">
            ...
            <section class="ages" id="categorias">
                <div>
<p class="eyebrow">ENCUENTRA EL REGALO PERFECTO</p><h2>Descubre juguetes<br>por categoría</h2></div>
                <div class="agegrid">
